...
export const todayPredictions: MatchPrediction[] = [
  ...
  // ==================== 1. 西班牙 vs 奥地利 (R32-10) ====================
  {
    ...
    recommendations: [
      { type: '胜平负', pick: '观望', odds: '—', modelProb: 0.706, reason: '❌ 无value。模型70.6%≈市场75.2%,赔率@1.33过低无正EV。所有方向gap<3pp,不值得下注。' },
    ],
  ...
  // ==================== 2. 葡萄牙 vs 克罗地亚 (R32-11) ====================
  {
    ...
    recommendations: [
      { type: '胜平负', pick: '克罗地亚胜', odds: '@5.33', modelProb: 0.290, reason: '✅ 本轮最佳VALUE! 模型29.0% vs 市场18.8% → gap+10.1pp, EV+54%。市场被R1 2-4英格兰锚定过深,R2/R3恢复证明首轮是意外。Modrić中场控制+淘汰赛经验。' },
    ],
  ...
  // ==================== 3. 瑞士 vs 阿尔及利亚 (R32-12) ====================
  {
    ...
    recommendations: [
      { type: '胜平负', pick: '阿尔及利亚胜', odds: '@4.36', modelProb: 0.271, reason: '✅ VALUE! 模型27.1% vs 市场22.9% → gap+4.2pp, EV+18%。R3 Mahrez双响3-3奥地利证明进攻爆发力。北非球队大赛韧性(2022摩洛哥四强效应)被市场低估。' },
    ],
  ...
  // ==================== 4. 澳大利亚 vs 埃及 (R32-13) ====================
  {
    ...
    recommendations: [
      { type: '胜平负', pick: '澳大利亚胜', odds: '@3.42', modelProb: 0.515, reason: '⚠️ 极端VALUE但高风险! 模型51.5% vs 市场29.2% → gap+22.3pp, EV+76%。Elo差+143支撑澳大利亚。但市场可能因Salah(利物浦)个人能力定价更高——Elo无法量化超级球星效应。建议小仓位。' },
    ],
  ...
  // ==================== 5. 阿根廷 vs 佛得角 (R32-14) ====================
  {
    ...
    recommendations: [
      { type: '胜平负', pick: '观望', odds: '—', modelProb: 0.867, reason: '❌ 无value。模型86.7%≈市场86.2%,@1.16赔率EV仅+0.6%。阿根廷必赢但赔率已充分反映,无下注意义。' },
    ],
  ...
  // ==================== 6. 哥伦比亚 vs 加纳 (R32-15) ====================
  {
    ...
    recommendations: [
      { type: '胜平负', pick: '哥伦比亚胜', odds: '@1.53', modelProb: 0.844, reason: '✅ 强VALUE! 模型84.4% vs 市场65.4% → gap+19.0pp, EV+29%。Elo差472碾压级+加纳进攻力几乎为零(off=-0.07)。虽然加纳def=-1.25(0-0英格兰),但哥伦比亚有James+L.Díaz创造力。90分钟内解决。' },
    ],
